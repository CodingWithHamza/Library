...
<body>
 <header>
        ...
        <div class="main-menu">
            ...
            {
                echo "<li class='navbar-item'><a href='customers/user_detail.php' class='nav-link'> My Account </a> </li>";
            }
                ?>
...
<body bgcolor="#FFFFFF">
	...
	<table width="1100" margen-top="30" border="2" cellspacing="2" cellpadding="2" bgcolor="#185578" align="center" style="color: #FFB233; margin-top: 35px; margin-bottom: 30px;">
		...
		<tr>
			...
			<td width="789"><p>Bank Name: Allied Bank</p>
				<p>Account no:0010000318570025 </p>
				<p>Branch Code:4851</p>
				<p>Branch Name: Mehmood Booti Road LHR.</p>

			</td>
		</tr>

		<tr>
			<th height="102" scope="row"> Easypaisa, Mobicash Details:</th>
			<td><p>C.N.I.C #:35201-2373923-5 </p>
				<p>Mobile no:0306-0481445</p>
				<p>Name: Ali Malik</p></td>
		</tr>

		<!-- <tr>
			<th </th>
			<td><p> </p>
				<p>C.N.I.C #:3467853331395 </p>
				<p></p>
